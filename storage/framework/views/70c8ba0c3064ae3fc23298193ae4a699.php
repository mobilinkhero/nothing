...
<?php endif; ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between mb-3 items-start">
        <!--[if BLOCK]><![endif]--><?php if(checkPermission('tenant.source.create')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1630358017-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
</div><?php /**PATH /home/ahtisham/app.chatvoo.com/resources/views/livewire/tenant/contact/manage-source.blade.php ENDPATH**/ ?>