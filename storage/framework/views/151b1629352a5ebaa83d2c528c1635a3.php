...
<?php endif; ?>
                                 ...
                                 <?php $__env->endSlot(); ?>
                                <?php if(auth()->user()->user_type !== 'admin' && ($subscription->isActive() ||
...
<?php endif; ?>
                 ...
                 <?php $__env->slot('content', null, []); ?> 
                    ...
                    <?php if($subscription->subscriptionLogs->isEmpty()): ?>
                    <div class="flex items-center text-gray-500">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="space-y-4 h-[570px] overflow-y-auto">
                        <?php $__currentLoopData = $subscription->getLogs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__currentLoopData = $subscription->invoices
                            ->sortBy([
                            fn($a) => $a->status !== 'new',
...
<?php endif; ?>
                                        ...
                                        <?php if($invoice->status === 'new' && !$invoice->hasPendingTransactions()): ?>
...
<?php endif; ?>
                ...
                <?php if($subscription->invoices->count() > 5): ?>
                <div
...
<?php endif; ?><?php /**PATH /home/ahtisham/app.chatvoo.com/resources/views/subscriptions/show.blade.php ENDPATH**/ ?>